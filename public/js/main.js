...
const i18n = {
  jp: {
    ...
    dining_tableware_label: 'Tableware',
    dining_tableware_title: '手作りの器',
    dining_tableware_body: 'お茶碗やお皿など、当施設のスタッフが手掛けるうつわに、薪火で仕立てた料理を盛り付けてご提供しています。ひとつひとつ表情が違う手仕事の器が、目に触れる瞬間から味わいの余韻まで、食の体験に温かみを添えます。',
    ...
    info_checkin_label: 'チェックイン',
    info_checkin_note: '最終チェックイン 18:00',
    info_checkout_label: 'チェックアウト',
    address: '兵庫県洲本市炬口247',
    tel: '0799-22-7775',
    footer_email_line: 'メール：awajiauberge★gmail.com',
    footer_email_note: '★を@に変更してお送りください。',
    access1_from: '洲本IC',
    access1_time: '10 min',
    access2_from: '新神戸',
    access2_time: '60 min',
    ...
    footer_ig_official: 'Instagram official',
    footer_ig_staff: 'Instagram staff',
    footer_terms: '宿泊約款',
    ...
    about_chef_body: '私が料理をつくるうえで大切にしているのは、淡路島の食材と、薪火の力です。イタリア料理から学んだ「素材の良さをそのまま活かすこと」。フランス料理から学んだ「技術によって食材の可能性をさらに広げること」。その両方を自分の中に持ちながら、一皿を組み立てています。<br><br>\n            薪火は、単なる加熱手段ではないと思っています。優しい火入れが食材の個性を守り、自然な燻香が奥行きを与えてくれる。油脂に頼らず、発酵調味料や熟成によって引き出した旨味を重ねることで、身体にも、心にも、心地よい味わいを目指しています。<br><br>\n            「熟成」「発酵」「薪火」。<br><br>\n            この三つをテーマに、ここ淡路島でしか生まれない料理を、あなたにお届けできたらと思っています。',
    ...
    faq_children_note: '大人の隠れ家として静かな空間をご提供するため、14歳未満のお子様のご宿泊はご遠慮いただいております。ご理解いただけますと幸いです。',
    ...
    faq_wifi: '無料Wi-Fi完備',
    faq_barrier_free: '館内に階段が多いため、バリアフリー対応は十分ではございません。お足元にご不安がある場合は、事前にスタッフまでご相談ください。できる限りお力添えいたします。',
    faq_cat_facility: 'ご滞在・施設について',
    faq_q_pet: 'ペットの同伴は可能ですか？',
    faq_a_pet: '誠に恐れ入りますが、ペットのご同伴はお断りしております。',
    faq_q_children: 'お子様の宿泊は可能ですか？',
    faq_q_parking_faq: '駐車場はありますか？',
    faq_q_wifi_faq: 'Wi-Fiは利用できますか？',
    faq_q_roomservice: 'ルームサービスはありますか？',
    faq_q_barrier: 'バリアフリーへの対応はありますか？',
    faq_q_amenity: '客室に用意されているアメニティを教えてください。',
    faq_a_amenity_intro: '以下のアメニティをご用意しております。',
    faq_q_payment: '利用できる支払い方法を教えてください。',
    faq_a_payment_intro: '以下の決済方法をご利用いただけます。',
    faq_qa_sub: 'よくあるご質問',
    faq_cat_sauna: 'サウナ・設備について',
    faq_cat_dining: 'お食事（夕食・朝食）について',
    faq_cat_stay: '宿泊・アクセスについて',
    faq_q_sauna_prep: 'サウナを利用する際に準備するものはありますか？',
    faq_a_sauna_prep: '当館の「マグマスパサウナ」はご宿泊の皆様にご利用いただける男女共用スペースとなっておりますため、ご自身で水着のご用意をいただくか、フロントでの貸出も行っております。',
    faq_q_sauna_temp: 'サウナの温度はどのくらいですか？',
    faq_a_sauna_temp: '室温は約65度と、一般的なドライサウナに比べて低めの「体に優しい温度設定」にしております。息苦しさがなく、遠赤外線効果で体の芯からじっくりと温まり、負担なく極上の「ととのい」をご体験いただけます。',
    faq_q_sauna_reserve: 'サウナは貸切や事前予約ができますか？',
    faq_a_sauna_reserve: '共用スペースとなりますため、特定の時間帯での貸切予約は承っておりません。ご滞在中は営業時間内であればいつでも、ご自身のペースで自由にご利用いただけます。当館は全8室と限られた客室数ですので、混雑を気にせずゆったりとお過ごしいただけます。',
    faq_q_roomwear: '館内着（ルームウェア）はありますか？',
    faq_a_roomwear: 'はい、お部屋には肌触りの良いルームウェアをご用意しております。サウナ後や就寝時など、どうぞ身軽でリラックスしてお過ごしください。',
    faq_q_dinner_time: '夕食の時間は決まっていますか？',
    faq_a_dinner_time: 'ご夕食は18時より一斉スタートとさせていただいております。オープンキッチンに設置された薪火オーブン「ジョスパー」から立ち上る炎や香りを、ライブ感とともにお楽しみください。',
    faq_q_allergy: 'アレルギーや苦手な食材への対応は可能ですか？',
    faq_a_allergy: 'はい、事前にお知らせいただければ可能な限り対応させていただきます。淡路ビーフや地元の鮮魚、自家農園の野菜など、その時々の旬の食材を最高の状態で仕入れるため、ご宿泊日の数日前までにお伝えいただけますと幸いです。',
    faq_q_guest_dining: '宿泊しない友人を夕食にだけ追加することはできますか？',
    faq_a_guest_dining: 'もちろん大歓迎です。ご宿泊者様と同じ「薪火が引き出すフルコース」をご友人様用に追加でご用意することが可能です。追加料金につきましては事前にお問い合わせください。',
    faq_q_luggage: 'チェックイン前に車を停めたり、荷物を預けることはできますか？',
    faq_a_luggage: 'はい、可能です。チェックインは15時からとなりますが、14時頃から当館駐車場をご利用いただけます。お荷物もフロントにてお預かりいたしますので、身軽な状態で洲本周辺の散策をお楽しみください。ラウンジスペースでおくつろぎいただくことも可能です。',
    faq_q_group: '大人数でのグループ宿泊や、全館貸切はできますか？',
    ...
    idx_concept_body: '私たちは、ただ美しい景色や贅沢な食事を提供するだけの宿泊施設ではありません。薪火料理とマグマ式スパで、心と体をリセットする特別な体験を。「魂が震える食事」と「心と体が満たされるオーベルジュ」——忘れられないひとときをお届けします。',
    idx_dining_h2: '薪火の美学',
    idx_dining_desc: '日本初導入のJOSPER®薪火グリルで調理する淡路ビーフと新鮮な海の幸。<br>18:00〜 季節のフルコース9品',
  ...
  en: {
    ...
    dining_tableware_label: 'Tableware',
    dining_tableware_title: 'Handcrafted<br>Tableware',
    dining_tableware_body: 'Tea bowls, plates, and other vessels shaped by our team — each piece unique. We serve our wood-fire cuisine on this handmade tableware, adding warmth from the first glance to the lingering finish of every course.',
    ...
    info_checkin_label: 'Check-in',
    info_checkin_note: 'Last check-in 18:00',
    info_checkout_label: 'Check-out',
    address: '247 Taikuchi, Sumoto, Hyogo',
    tel: '0799-22-7775',
    footer_email_line: 'Email: awajiauberge★gmail.com',
    footer_email_note: 'Replace ★ with @ when sending.',
    ...
    faq_children_note: 'In order to provide a peaceful retreat for adults, we regret that guests under 14 years of age are unable to stay. We appreciate your understanding.',
    ...
    faq_barrier_free: 'The building contains a number of staircases and is not fully accessible. Should you have any mobility concerns, please feel free to consult our staff in advance — we will do our best to assist you.',
    faq_cat_facility: 'Stay & Facilities',
    faq_q_pet: 'Are pets permitted?',
    faq_a_pet: 'We regret that pets are not permitted on the premises.',
    faq_q_children: 'Can children stay?',
    faq_q_parking_faq: 'Is parking available?',
    faq_q_wifi_faq: 'Is Wi-Fi available?',
    faq_q_roomservice: 'Is room service available?',
    faq_q_barrier: 'Is the property accessible for guests with mobility needs?',
    faq_q_amenity: 'What amenities are provided in the room?',
    faq_a_amenity_intro: 'The following amenities are provided.',
    faq_q_payment: 'What payment methods are accepted?',
    faq_a_payment_intro: 'The following payment methods are accepted.',
    faq_qa_sub: 'Frequently Asked Questions',
    faq_cat_sauna: 'Sauna & Facilities',
    faq_cat_dining: 'Dining (Dinner & Breakfast)',
    faq_cat_stay: 'Stay & Access',
    faq_q_sauna_prep: 'What do I need to bring to use the sauna?',
    faq_a_sauna_prep: 'Our Magma Spa Sauna is a mixed-gender shared facility available to all staying guests. You are welcome to bring your own swimwear, or we can provide a rental at the front desk.',
    faq_q_sauna_temp: 'What temperature is the sauna?',
    faq_a_sauna_temp: 'The sauna is kept at approximately 65°C — lower than a typical dry sauna, making it gentle on the body. The far-infrared rays warm you from within without any stuffiness, offering a deeply restorative "totonou" experience.',
    faq_q_sauna_reserve: 'Can I reserve the sauna for private use?',
    faq_a_sauna_reserve: 'As the sauna is a shared space, private reservations for specific time slots are not available. You are free to use it at your own pace during operating hours. With only 8 rooms, crowding is rarely a concern.',
    faq_q_roomwear: 'Is roomwear / loungewear available?',
    faq_a_roomwear: 'Yes, soft and comfortable loungewear is provided in each room. Perfect for relaxing after the sauna or at bedtime.',
    faq_q_dinner_time: 'Is there a fixed dinner time?',
    faq_a_dinner_time: 'Dinner begins simultaneously for all guests at 18:00. Enjoy the live atmosphere as flames rise from the wood-fire Josper oven in our open kitchen.',
    faq_q_allergy: 'Can you accommodate allergies or dietary preferences?',
    faq_a_allergy: 'Yes, we will do our best to accommodate any allergies or dietary needs if notified in advance. As we source the finest seasonal ingredients — including Awaji beef, local seafood, and vegetables from our own farm — we kindly ask that you let us know a few days before your stay.',
    faq_q_guest_dining: 'Can a non-staying friend join for dinner?',
    faq_a_guest_dining: 'Absolutely — we welcome dining guests warmly. We can prepare the same wood-fire full course for your friend at an additional charge. Please contact us in advance for pricing and arrangements.',
    faq_q_luggage: 'Can I park or leave my luggage before check-in?',
    faq_a_luggage: 'Yes, of course. Check-in begins at 15:00, but our car park is available from around 14:00. We are also happy to store your luggage at the front desk so you can explore Sumoto with ease. You are welcome to relax in our lounge while you wait.',
    faq_q_group: 'Can we book a full buyout for a large group?',
    ...
    idx_concept_body: 'We are more than a beautiful view and a luxurious meal. Wood-fire cuisine and our magma spa offer a profound reset for mind and body. "A meal that moves the soul" and "an auberge that fulfils body and spirit" — an unforgettable experience awaits.',
    idx_dining_h2: 'The Aesthetics of Fire',
    idx_dining_desc: 'Awaji beef and the freshest seafood, cooked on Japan\'s first JOSPER® wood-fire grill.<br>Full course, 9 dishes from 18:00',
